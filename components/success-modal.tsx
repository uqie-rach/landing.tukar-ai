    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <Card className="relative floating-card border-0 rounded-2xl max-w-md w-full animate-slide-in">
        <CardContent className="p-8 text-center">
          ...
          <h3 className="text-3xl font-bold text-card-foreground mb-4">Welcome, {name}!</h3>

          <p className="text-lg text-muted-foreground leading-relaxed mb-6">
            Thank you for joining Tukar's early access program. We've sent you an email with download instructions and
            exclusive updates.
          </p>
          ...
          <Button
            onClick={onClose}
            className="enhanced-gradient-button text-white px-8 py-3 text-base font-medium rounded-xl border-0"
          >
            Continue Exploring
          </Button>
        </CardContent>
